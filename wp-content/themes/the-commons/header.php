...
<div class="header-menu hidden-mobile">
    <div class="menu-container">
        ...
        <li class="menu-item" onclick="menuHandler('paid-videos')">Features</li>
...
<div class="newsy-header-mobile hidden-desktop">
    ...
    <div class="hamburger-menu" >
        ...
        <ul class="menu-box">
            ...
            <li class="menu-item-mobile" onclick="menuHandler('paid-videos')"><div class="menu-text-mobile">Features</div></li>
