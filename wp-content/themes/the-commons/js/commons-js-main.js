...
jod_art.addEventListener(
    ...
    (event) => {
      ...
      jod_art_join.style.transform = "translate(" + (Math.random()*jod_art.offsetWidth-jod_art_join.offsetWidth) + "px, calc( " + (Math.random()*jod_art.offsetHeight-jod_art_join.offsetHeight) + " - 100%)px)";
